...
import { Volume2, Radio, Play, Pause } from 'lucide-react';
    ...
    >
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
        ...
        >
          ...
          <h2
            id="audio-heading"
            className="font-mondwest text-3xl md:text-4xl font-semibold text-[#0D212C] tracking-tight mb-4"
          >
          ...
          <p
            ...
            className="text-sm md:text-base text-[#051A24] leading-relaxed font-normal"
          >
