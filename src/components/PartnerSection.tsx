  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 p-3.5 sm:p-4 bg-gradient-to-t from-[#051A24]/95 via-[#051A24]/60 to-transparent pt-12 flex flex-col text-left pointer-events-none">
        ...
        <h4 className="font-mondwest text-lg sm:text-xl font-semibold text-white tracking-tight leading-tight">
          {video.title}
        </h4>
      </div>
    </div>
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h2
          id="partner-heading"
          className="font-mondwest text-[38px] sm:text-[48px] md:text-[56px] lg:text-[68px] leading-[1.08] text-[#0D212C] max-w-4xl tracking-tight mb-4 select-none"
        >
